...
#
#
write.csv(df_wide, "data/study4_data_wide.csv", row.names = FALSE)
write.csv(df_wide_clean, "data/study4_data_wide_clean.csv", row.names = FALSE)
write.csv(df_long, "data/study4_data_long.csv", row.names = FALSE)
write.csv(df_long_clean, "data/study4_data_long_clean.csv", row.names = FALSE)
#
#
